...
import { Music, CheckCircle2, Lock, AlertCircle } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-4xl flex flex-col md:flex-row overflow-hidden rounded-2xl shadow-2xl bg-aria-dark/50 border border-white/10 m-4">
        ...
        <div className="w-full md:w-1/2 p-12 bg-gradient-to-br from-aria-blue/90 to-aria-dark/90 text-white flex flex-col justify-between relative overflow-hidden">
            ...
            <div>
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2 bg-aria-gold rounded-full text-aria-dark">
              ...
              <p className="text-gray-300 font-light leading-relaxed">
                Scopri esperienze di viaggio esclusive nei teatri più prestigiosi d'Italia. 
                Entra nel mondo della lirica con pacchetti curati nei minimi dettagli.
              </p>
            </div>
            
            <div className="mt-8 space-y-3">
              <div className="flex items-center gap-3 text-sm text-gray-300">
                <CheckCircle2 className="w-4 h-4 text-aria-gold" />
                <span>Accesso esclusivo ai teatri</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-gray-300">
                <CheckCircle2 className="w-4 h-4 text-aria-gold" />
                <span>Pernottamenti di lusso</span>
              </div>
              <div className="flex items-center gap-3 text-sm text-gray-300">
                <CheckCircle2 className="w-4 h-4 text-aria-gold" />
                <span>Esperienze gastronomiche</span>
              </div>
            </div>
        </div>
        ...
        <div className="w-full md:w-1/2 p-12 bg-white/5 backdrop-blur-md flex flex-col justify-center">
          ...
          <p className="text-gray-400 text-sm mb-8">
            {isRegistering 
              ? 'Iscriviti per accedere alle offerte esclusive.' 
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {isRegistering && (
              <div>
                ...
                <input
                  ...
                  className="w-full bg-black/20 border border-white/10 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-aria-gold transition-colors placeholder-gray-600"
              ...
              <div>
                 ...
                 <div className="grid grid-cols-2 gap-4 mb-4">
                    <button
                      ...
                      className={`px-4 py-3 rounded-lg text-sm font-medium border transition-all ${
                        role === 'USER' 
                          ? 'bg-aria-gold text-aria-dark border-aria-gold' 
                 ...
                 {role === 'ADMIN' && (
                    <div className="animate-in fade-in slide-in-from-top-2 duration-300">
                       <label className="block text-xs uppercase tracking-wider text-aria-gold mb-1 flex items-center gap-1">
                          <Lock className="w-3 h-3" /> Codice Amministratore
                       </label>
                       <input
                          type="password"
                          required
                          ...
                          className="w-full bg-black/20 border border-aria-gold/50 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-aria-gold transition-colors placeholder-gray-600"
                          placeholder="Richiedi codice al CEO"
                        />
                    </div>
                 )}
              </div>
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-aria-gold to-yellow-600 text-white font-bold py-3 rounded-lg shadow-lg hover:shadow-xl hover:opacity-90 transition-all transform hover:-translate-y-0.5 mt-4"
            >
          ...
          <div className="mt-6 text-center">
            <button
              ...
              className="text-sm text-gray-400 hover:text-aria-gold transition-colors underline decoration-dotted"
            >
